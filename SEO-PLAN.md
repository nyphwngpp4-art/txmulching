...
- **Money page** `/forestry-mulching`: targets "forestry mulching", "forestry mulching near me" and "forestry mulching texas", the top GBP searches. Every heading is phrased the way people ask the question and answered in its first line; the page covers what drives cost (no dollar figures, which stay in the instant estimate), acres per day, mulching vs. bulldozing and what's left behind. Excavation is described as done by the owner, with specialized equipment sourced through his contacts. The estimate call-to-action appears near the top, mid-page and at the end.
...
- `/excavation`: **next page to build.** It targets the #2 GBP search. Needs the owner's actual list of dirt-work services first.
